...
| Command | Behavior |
|---|---|
| `npx dice` | Show help in English |
| `npx dice help` | Show help in English |
| `npx dice help --ja` | Show help in Japanese |
| `npx dice <1-9>` | Roll and display N dice |
| `npx dice <0 or less / 10 or more / text>` | Show an error |
